...
ActiveRecord::Schema.define(version: 20_230_105_222_032) do
  ...
  create_table 'ticket_watchers', id: false, force: :cascade do |t|
    ...
    t.index %w[ticket_id user_id], name: 'index_ticket_watchers_on_ticket_id_and_user_id', unique: true
    t.index %w[user_id ticket_id], name: 'index_ticket_watchers_on_user_id_and_ticket_id'
  end
